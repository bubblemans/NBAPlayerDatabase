...
public:
    ...
    virtual bool uniqueKeyTreeInsert    ( ItemType  newData) = 0;
    virtual void secondaryKeyTreeInsert ( ItemType  newData) = 0;
    
    virtual bool deleteUniqueKey       (ItemType & targetKey) = 0;
    virtual bool deleteOtherKeys       (ItemType targetKey, string) = 0;
    virtual bool getEntryUniqueTree    (ItemType & anEntry, ItemType & returnedItem) = 0;
